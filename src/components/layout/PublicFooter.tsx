...
import { HeartPulse, Phone, MapPin, ShieldAlert, Clock, QrCode } from 'lucide-react';
            ...
            <div className="space-y-4 md:col-span-2">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl bg-teal-50 dark:bg-teal-950 text-teal-700 dark:text-teal-300 border border-teal-200 hover:bg-teal-100 transition-colors font-semibold"
                >
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                ...
                <li>
                  <button
                    onClick={() => setIsQRModalOpen(true)}
                    className="hover:text-teal-600 transition-colors text-teal-700 dark:text-teal-300 font-semibold flex items-center gap-1"
                  >
                    <QrCode className="h-3.5 w-3.5" />
